        ...
        <div className="mx-auto max-w-6xl">
          <div className="bg-white rounded-lg shadow-xl p-8 md:p-12">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="text-center p-6 bg-[#f8f9fa] rounded-lg">
                <div className="mb-4 flex justify-center">
                  <svg className="h-12 w-12 text-[#8FAE8F]" fill="currentColor" viewBox="0 0 640 512">
            ...
            {/* Discount Code */}
            <div className="bg-[#8FAE8F] rounded-lg p-6 text-center">
              ...
              <div className="bg-white rounded-lg py-4 px-8 inline-block">
                <span className="text-3xl font-bold text-[#8FAE8F]" style={{ fontFamily: "'Courier New', monospace" }}>
                  WAGGINMEALS
                </span>
              </div>
              ...
              <div className="mt-6">
                <a
                  ...
                  className="inline-block bg-white text-[#8FAE8F] px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition-colors shadow-lg"
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f8f9fa] rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow">
              <div className="bg-[#8FAE8F] p-6 text-center">
