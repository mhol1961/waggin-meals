...
export async function POST(request: NextRequest) {
  try {
    ...
    // ====================================
    // DISABLED: Inventory tracking causing order failures
    // TODO: Re-enable once inventory system is stable
    console.log('[Order] Inventory check disabled - proceeding with order');
      ...
      return NextResponse.json(
        {
          ...
          details: orderError.message || JSON.stringify(orderError),
