                ...
                >
                  <div className="grid md:grid-cols-3 gap-6 p-8">
                    ...
                    <div className="md:border-r md:border-gray-300 md:pr-6">
                      <div className="bg-[#a5b5eb] text-white inline-block px-3 py-1 rounded-full text-xs font-semibold mb-4" style={{ fontFamily: "'Poppins', sans-serif" }}>
                        {event.type}
                      </div>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-start gap-2">
                          <svg className="w-5 h-5 text-[#a5b5eb] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <ul className="grid md:grid-cols-2 gap-2">
                        {event.highlights.map((highlight, i) => (
                          <li key={i} className="flex items-start gap-2">
                            <svg className="w-4 h-4 text-[#a5b5eb] flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      <div className="mt-6 flex flex-wrap gap-3">
                        <a
                          ...
                          className="inline-block bg-white border-2 border-[#a5b5eb] text-[#a5b5eb] px-6 py-2 rounded-lg text-sm font-semibold hover:bg-[#a5b5eb] hover:text-white transition-colors"
                          style={{ fontFamily: "'Poppins', sans-serif" }}
                        >
                          Get Directions
                        </a>
                        <Link
                          href="/contact"
                          className="inline-block bg-[#a5b5eb] text-white px-6 py-2 rounded-lg text-sm font-semibold hover:bg-[#8a9fd9] transition-colors"
                          style={{ fontFamily: "'Poppins', sans-serif" }}
                        >
