...
export default function HeightCompact() {
    ...
    <main className="bg-[#f5f1ea] min-h-screen">
      ...
      <section className="relative px-4 py-8 overflow-hidden">
        ...
        <div className="absolute top-4 right-4 bg-[#bc2c2c] text-white px-4 py-2 rounded-lg text-xs font-bold z-50 shadow-lg">
          Hero Height: COMPACT (Minimal Spacing)
        </div>
        ...
        <div className="mx-auto max-w-6xl relative z-10 grid lg:grid-cols-[1.15fr_0.85fr] gap-8 items-center">
          ...
          <div>
            ...
            <h1 className="text-[42px] leading-[1.05] text-[#1f1a16] mb-6" style={{ fontFamily: "'Abril Fatface', serif" }}>
              When veterinarians can't find answers,
              <br />
              <span className="text-[#bc2c2c]">we dig deeper.</span>
            </h1>

            <p className="text-base text-[#4a443b] mb-8 leading-relaxed" style={{ fontFamily: "'Poppins', sans-serif" }}>
