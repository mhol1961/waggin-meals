  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-4 pb-20">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-gradient-to-br from-[#e8f4fb] to-[#f0f4ff] rounded-2xl p-8 mb-8 border-l-4 border-[#a5b5eb]">
              <div className="flex items-start gap-6">
                <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#a5b5eb] to-[#c5d4f7] flex items-center justify-center flex-shrink-0 border-4 border-white shadow-lg">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-[14px]" style={{ fontFamily: "'Poppins', sans-serif" }}>
                    ...
                    <div className="flex items-center gap-2">
                      <Heart className="w-4 h-4 text-[#a5b5eb]" />
            ...
            <section className="mb-12">
              <h3 className="text-[28px] font-bold text-[#3c3a47] mb-6 flex items-center gap-3" style={{ fontFamily: "'Abril Fatface', serif" }}>
                <div className="w-10 h-10 rounded-full bg-[#a5b5eb]/20 flex items-center justify-center">
                  <span className="text-[#a5b5eb] font-bold">1</span>
                </div>
                The Challenge
              </h3>
            ...
            <section className="mb-12">
              <h3 className="text-[28px] font-bold text-[#3c3a47] mb-6 flex items-center gap-3" style={{ fontFamily: "'Abril Fatface', serif" }}>
                <div className="w-10 h-10 rounded-full bg-[#a5b5eb]/20 flex items-center justify-center">
                  <span className="text-[#a5b5eb] font-bold">2</span>
                </div>
                Christie\'s Clinical Recommendation
              </h3>

              <div className="bg-gradient-to-br from-[#a5b5eb]/10 to-[#c5d4f7]/10 rounded-2xl p-8 mb-6 border-2 border-[#a5b5eb]/20">
                <div className="flex items-start gap-4 mb-6">
                  <Quote className="w-8 h-8 text-[#a5b5eb] flex-shrink-0" />
                  <div>
                ...
                <div className="bg-white border-2 border-[#e0e0e0] rounded-xl p-6">
                  ...
                  <ul className="space-y-2 text-[15px] text-[#666666]" style={{ fontFamily: "'Poppins', sans-serif" }}>
                    <li className="flex items-start gap-2">
                      <span className="text-[#a5b5eb] mt-1">•</span>
            ...
            <section className="mb-12">
              <h3 className="text-[28px] font-bold text-[#3c3a47] mb-6 flex items-center gap-3" style={{ fontFamily: "'Abril Fatface', serif" }}>
                <div className="w-10 h-10 rounded-full bg-[#a5b5eb]/20 flex items-center justify-center">
                  <span className="text-[#a5b5eb] font-bold">3</span>
                </div>
                Personalized Feeding Plan
              </h3>

              <div className="bg-gradient-to-br from-[#f0f4ff] to-[#e8f4fb] rounded-2xl p-8 mb-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="bg-white rounded-lg p-4">
                      <p className="text-[24px] font-bold text-[#a5b5eb] mb-1">2.0-2.5 cups</p>
                  ...
                  <div>
                    ...
                    <div className="bg-white rounded-lg p-4">
                      <p className="text-[24px] font-bold text-[#a5b5eb] mb-1">14.0-17.5 cups</p>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 border-2 border-[#e0e0e0]">
                ...
                <ul className="space-y-3 text-[14px] text-[#666666]" style={{ fontFamily: "'Poppins', sans-serif" }}>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-[#a5b5eb] flex-shrink-0 mt-0.5" />
              ...
              <div className="bg-gradient-to-br from-[#a5b5eb]/10 to-[#c5d4f7]/10 rounded-2xl p-6 border-2 border-[#a5b5eb]/20">
                ...
                <p className="text-[14px] text-[#666666] mb-4" style={{ fontFamily: "'Poppins', sans-serif" }}>
                  For every person you refer, earn <strong className="text-[#a5b5eb]">$10 credit</strong> towards your next order!
                </p>
              ...
              <Link
                ...
                className="block w-full bg-[#a5b5eb] text-white text-center px-6 py-4 rounded-full hover:bg-[#8fa3d9] transition-colors font-semibold"
                style={{ fontFamily: "'Poppins', sans-serif" }}
              >
        ...
        <div className="mt-16 bg-gradient-to-br from-[#f8f9fa] to-[#e8f4fb] rounded-3xl p-12 text-center">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex justify-center gap-4 flex-wrap">
              <Link
                href="/contact"
                className="bg-[#a5b5eb] text-white px-8 py-4 rounded-full hover:bg-[#8fa3d9] transition-colors font-semibold"
                style={{ fontFamily: "'Poppins', sans-serif" }}
              >
                Start Your Journey
              </Link>
              <Link
                href="/case-studies"
                className="bg-white text-[#a5b5eb] border-2 border-[#a5b5eb] px-8 py-4 rounded-full hover:bg-[#a5b5eb] hover:text-white transition-colors font-semibold"
                style={{ fontFamily: "'Poppins', sans-serif" }}
              >
