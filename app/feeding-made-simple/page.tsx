          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg p-8 shadow-md">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-[#a5b5eb] rounded-full flex items-center justify-center text-white text-2xl font-bold mr-4">
                  1
                </div>
              ...
              <Link
                ...
                className="inline-block text-[#a5b5eb] font-semibold hover:text-[#8a9fd9] text-[14px]"
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  <div className="h-8 bg-gradient-to-r from-[#a5b5eb] to-[#e0e0e0] rounded-full relative">
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  <div className="h-8 bg-gradient-to-r from-[#a5b5eb] via-[#c5d4f7] to-[#e0e0e0] rounded-full relative">
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  <div className="h-8 bg-gradient-to-r from-[#a5b5eb] via-[#b5c7f0] to-[#e0e0e0] rounded-full relative">
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  <div className="h-8 bg-[#a5b5eb] rounded-full relative">
      ...
      <section className="bg-[#f8f9fa] px-4 py-16">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              <div className="mb-4 flex justify-center">
                <svg className="h-12 w-12 text-[#a5b5eb]" fill="currentColor" viewBox="0 0 576 512">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              className="bg-[#a5b5eb] text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-[#8a9fd9] transition-colors shadow-lg"
              style={{ fontFamily: "'Poppins', sans-serif" }}
            >
              Book a Consultation
            </Link>
            <Link
              href="/feeding-calculator"
              className="bg-white border-2 border-[#a5b5eb] text-[#a5b5eb] px-8 py-4 rounded-full text-lg font-semibold hover:bg-[#a5b5eb] hover:text-white transition-colors shadow-lg"
              style={{ fontFamily: "'Poppins', sans-serif" }}
            >
