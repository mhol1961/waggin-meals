...
// Use anon key since this is what the app uses
...
async function createTestPage() {
  ...
  try {
    ...
    console.log('\n🔗 URLs:');
    console.log(`   Admin Edit: https://wagginmeals.com/admin/conditions/${data.id}/edit`);
    console.log(`   Public:     https://wagginmeals.com/conditions/${data.slug}`);

    console.log('\n✅ Test page ready to view!\n');
