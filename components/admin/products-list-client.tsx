...
export default function ProductsListClient({ initialProducts }: ProductsListClientProps) {
  ...
  const handleArchiveComplete = (productId: string) => {
    ...
    <>
      <div className="mb-6 flex justify-between items-center">
        <div className="text-sm text-gray-600">
          {activeProducts.length} {activeProducts.length === 1 ? 'product' : 'products'} total
        </div>
        <Link
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div className="flex justify-end items-center gap-3">
                      ...
                      <ArchiveButton
                        ...
                        onArchiveComplete={() => handleArchiveComplete(product.id)}
                      />
                    </div>
                  </td>
                </tr>
